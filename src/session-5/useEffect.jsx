...
const Counter_useEffect  = (props,ref) => {
    ...
    // useEffect accept the function as a argument, useEffect(()=>{}), so useEffect() is a callback function.
    ...
    useEffect(()=>{
        console.log("MOUNTING: this will execute only 1 time after 1st time DOM loaded")
    },[])
    ...
    useEffect(()=>{
        console.log("UPDATING: this will execute when we are changing the value of element in dependence-array i.e count")
    },[count])
