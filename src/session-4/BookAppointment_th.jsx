        ...
        <div>
            {formSubmitted ? (
                <div className="cancle-div">
                    ...
                    <button onClick={() => {setFormSubmitted(false);window.location.reload()}}>Cancle appointment</button>
                </div>
            ) : (
                <div>
                    ...
                    {loading ? <h3>Scheduling the appointment</h3> : <form className="deails" onSubmit={formHandler}>
                        <p>
